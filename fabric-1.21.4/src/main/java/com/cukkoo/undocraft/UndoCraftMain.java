...
public class UndoCraftMain implements ModInitializer {
    ...
    public void onInitialize() {
        PayloadTypeRegistry.playC2S().register(UndoPayload.TYPE, UndoPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(HasHistoryPayload.TYPE, HasHistoryPayload.CODEC);
